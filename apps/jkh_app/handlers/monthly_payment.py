...
#     WaterTariffModel, AreaTariffModel, PaymentRecord
# )
# from celery import shared_task
#
#
# @shared_task
# def calculate_payments_for_house(house):
...
#         return {"status": "error", "message": "Тарифы не найдены"}, 400
#
...
#                 continue
#
#             current_reading = readings[0]  # Последнее показания счетчика
#             previous_reading = readings[1]  # Предыдущее показания счетчика
#
